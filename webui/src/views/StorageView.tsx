...
import { StorageApi, Configuration, ApiDisk } from 'artifacts/clients/typescript';
                  ...
                  >
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
                      ...
                      <div style={{ textAlign: 'right' }}>
                        ...
                        <div style={{ fontSize: '0.75rem', color: 'var(--color-text-secondary)' }}>{d.kname}</div>
                      </div>
                    </div>
